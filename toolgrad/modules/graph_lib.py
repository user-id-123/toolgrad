...
def sample_apis_or_end(
  ...
  # Sample APIs
  toolgrad_state.sampled_apis = toolbench_langchain_utils.get_all_apis(num_apis)
  return toolgrad_state


@log_utils.log_time
def api_proposer(toolgrad_state: ToolGradState,) -> Union[ToolGradState, str]:
...
@log_utils.log_time
def api_executor(toolgrad_state: ToolGradState,) -> ToolGradState | str:
